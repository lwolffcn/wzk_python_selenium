...
curPath = os.path.abspath(os.path.dirname(__file__))  # D:\wzk_python_selenium\PC4.0
...
# 构造测试集
# test_dir= './'
test_dir = curPath + '\\testcase' # D:\wzk_python_selenium\PC4.0\testcase
report_dir = curPath + '\\report'  # D:\wzk_python_selenium\PC4.0\report
# test_dir2 = 'D:\\wzk_python_selenium\\PC4.0\\testcase\\'
print(test_dir)
print(report_dir)
discover = unittest.defaultTestLoader.discover(test_dir, pattern='*wzk4.py')
